$(function() {
    ...
    if($("#wheatherChartEcharts").length) {
        ...
        var weatherIcons = {
            'Sun': '././assets/img/weather/sunny_128.png',
    ...
    if(document.getElementById('donutChartEcharts2')) {
            var donutChart = echarts.init(document.getElementById('donutChartEcharts2'));
            ...
            var donutOption = {
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: ['PDV realisee', 'RDV non realisee']
                },
                series: [
                    {
                        name: 'Plan de Contact',
                        type: 'pie',
                        radius: ['50%', '70%'],
                        ...
                        data: [
                            { value: 234, name: 'PDV realisee' },
                            { value: 135, name: 'Clients restants' }
                        ]
                    }
                ]
            };
        ...
        if(document.getElementById('donutChartEcharts')) {
            ...
            var donutOption = {
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: ['Clients traités', 'Clients restants']
                },
                series: [
                    {
                        name: 'Plan de Contact',
                        ...
                        data: [
                            { value: 234, name: 'UE restants' },
                            { value: 135, name: 'UE Realisee' }
                        ]
                    }
                ]
            };
